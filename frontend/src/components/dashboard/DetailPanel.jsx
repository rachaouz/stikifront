...
// ── Field — ligne label/valeur dans le panneau détail ─────────────────────────
...
// ── DetailPanel ───────────────────────────────────────────────────────────────
/**
 * Panneau de détail d'un IOC sélectionné.
 * Props : ioc (null = état vide), C (thème)
 */
  ...
  return (
    <div style={{ padding: "24px", overflowY: "auto", height: "100%", scrollbarWidth: "thin", scrollbarColor: `${C.scrollThumb} transparent` }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "18px", padding: "16px", background: C.surface, border: `1px solid ${scC}20`, borderRadius: "10px", marginBottom: "20px" }}>
        ...
        <div style={{ flex: 1 }}>
          <div style={{ fontSize: "0.55rem", letterSpacing: "0.18em", color: C.textFaint, marginBottom: "8px", fontFamily: "'DM Mono', monospace" }}>
            RISK SCORE
          </div>
          ...
          <div style={{ marginTop: "8px", fontFamily: "'Syne', sans-serif", fontSize: "1.4rem", fontWeight: 800, color: scC }}>
            {sc}
            <span style={{ fontSize: "0.7rem", fontFamily: "'DM Mono', monospace", color: C.textFaint, fontWeight: 400 }}>/100</span>
          </div>
        </div>
      </div>

      <Field C={C} label="VERDICT"        value={(ioc.final_verdict || "UNKNOWN").toUpperCase()} color={tm.color} />
